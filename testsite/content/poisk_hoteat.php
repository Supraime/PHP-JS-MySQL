<div class="content">
	...
	<?
		...
		$text = $_POST['query'];
		$res = mysql_query("SELECT * FROM `hoteat` WHERE `title` LIKE '%$text%' OR `kr_descript` LIKE '%$text%'");
...

{
	if ($ar['id']== null){
		...
		$result = mysql_query("SELECT * FROM `hoteat` WHERE `title` LIKE '%$text%' OR `kr_descript` LIKE '%$text%'");
